        ...
        <div className="w-full max-w-md">
          ...
          <div className="bg-card/60 backdrop-blur-xl border border-border/40 rounded-2xl p-8 shadow-xl">
            <div className="space-y-6">
              <button className="w-full relative overflow-hidden bg-white text-gray-900 border border-gray-200 hover:bg-gray-50 px-6 py-4 rounded-xl transition-all duration-300 hover:scale-[1.02] hover:shadow-lg group flex items-center justify-center space-x-3">
